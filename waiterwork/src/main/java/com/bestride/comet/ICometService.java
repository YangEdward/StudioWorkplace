...
//   private static final String COMET_HOST = "http://www.ideawu.com";
   	private static final String COMET_HOST = "192.168.2.200";
        ...
        public void handleMessage(android.os.Message msg) {
            ...
            switch (msg.what) {
                case WHAT_MESSAGE:
                    ...
                    Intent intent = new Intent(FinalValue.ACTION_MESSAGE_ARRIVED);
...
//			conf.host = "10.0.2.2";
    ...
    static class SubTask extends AsyncTask<Void, Void, Void> {
    ...
    class MyCometCallback implements ICometCallback {
        ...
        @Override
        public void onDataMsgArrived(String arg0) {
            log(arg0.toString());
