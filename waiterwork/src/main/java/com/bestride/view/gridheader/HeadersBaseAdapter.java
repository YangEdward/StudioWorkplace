...
/**
 * Base adapter interface for HeadersGridView. The adapter expects two
 ...
 * {@link HeadersSimpleAdapter} for a solution which will
 * auto-generate the set of headers.
 *
 * @author Edward
 */
public interface HeadersBaseAdapter extends ListAdapter {
    /**
