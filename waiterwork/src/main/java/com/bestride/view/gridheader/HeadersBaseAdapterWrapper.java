 ...
 * @author Edward
 */
public class HeadersBaseAdapterWrapper extends BaseAdapter {
    ...
    private final HeadersBaseAdapter mDelegate;

    private HeadersGridView mGridView;
    ...
    public HeadersBaseAdapterWrapper(Context context, HeadersGridView gridView,
            HeadersBaseAdapter delegate) {
        mContext = context;
        mDelegate = delegate;
        mGridView = gridView;
     ...
     */
    public HeadersBaseAdapter getWrappedAdapter() {
        return mDelegate;
    }
