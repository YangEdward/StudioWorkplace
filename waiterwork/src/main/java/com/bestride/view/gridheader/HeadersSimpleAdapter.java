...
/**
 * Adapter interface for HeadersGridView. The adapter expects two sets
 ...
 * {@link com.bestride.view.gridheader.HeadersBaseAdapter}.
 * 
 * @author Tonic Artos
 */
public interface HeadersSimpleAdapter extends ListAdapter {
    /**
