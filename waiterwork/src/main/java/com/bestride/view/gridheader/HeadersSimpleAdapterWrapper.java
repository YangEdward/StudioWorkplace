 ...
 * @author Edward
 */
public class HeadersSimpleAdapterWrapper extends BaseAdapter implements
        HeadersBaseAdapter {
    private HeadersSimpleAdapter mDelegate;

    private HeaderData[] mHeaders;

    public HeadersSimpleAdapterWrapper(HeadersSimpleAdapter adapter) {
        mDelegate = adapter;
    ...
    protected HeaderData[] generateHeaderList(HeadersSimpleAdapter adapter) {
