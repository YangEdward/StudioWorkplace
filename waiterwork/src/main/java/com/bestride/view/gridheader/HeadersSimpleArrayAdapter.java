 ...
 * @param <T>
 */
public class HeadersSimpleArrayAdapter<T> extends BaseAdapter implements
        HeadersSimpleAdapter {
    protected static final String TAG = HeadersSimpleArrayAdapter.class.getSimpleName();
    ...
    public HeadersSimpleArrayAdapter(Context context, List<T> items, int headerResId,
            int itemResId) {
        init(context, items, headerResId, itemResId);
    }

    public HeadersSimpleArrayAdapter(Context context, T[] items, int headerResId,
            int itemResId) {
